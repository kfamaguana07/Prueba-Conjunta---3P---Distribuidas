/** Pantalla de inicio de sesión — diseño premium (tarjeta sobre fondo burdeos). */
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.card}>
          ...
          <Pressable style={[styles.cta, loading && styles.ctaDisabled]} onPress={onSubmit} disabled={loading}>
            <Text style={styles.ctaText}>{loading ? 'Entrando…' : 'Iniciar sesión'}</Text>
          </Pressable>
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: serif, fontSize: 28, fontWeight: fontWeight.bold, color: colors.wine, marginTop: spacing.sm, textAlign: 'center' },
